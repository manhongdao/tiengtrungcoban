...
export function Sidebar({className, open = false}: InferProps<typeof Sidebar.propTypes>) {


    return (
        <div className={clsx('absolute w-full h-screen overflow-hidden', open ? 'block' : 'hidden', className)}>
            <div className="fixed inset-0 bg-black opacity-30 overflow-hidden" aria-hidden="true" />
            <aside className="w-64 z-20 absolute h-screen bg-white top-0 right-0" aria-label="Sidebar">
